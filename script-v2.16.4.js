...
var fraisGestionBePortageUpdate = document.getElementById("myFraisGestionBePortage").value;
document.getElementById("myFraisGestionBePortage").addEventListener("change", updateBePortage(fraisGestionBePortageUpdate));
...
var fraisGestionBePortage = 5; //get
var cainto100BePortage = caBePortage / 100 ;

// Frais de gestion
document.getElementById("myFraisGestionBePortage").innerHTML = fraisGestionBePortage;

function updateBePortage(fraisGestionBePortage) { 
...
updateBePortage(fraisGestionBePortage);
...
// Frais de gestion
document.getElementById("myFraisGestionDidaxis").innerHTML = fraisGestionDidaxis + "%";
