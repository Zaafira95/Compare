...
document.getElementById("myFraisGestionEGS").innerHTML = formatter2.format(fraisGestionEGS);
...
document.getElementById("myFraisPortageo").innerHTML = formatter2.format(fraisPortageo);document.getElementById("myFraisGestionEGS").innerHTML = formatter2.format(fraisGestionEGS);
document.getElementById("myFraisGestionPortageo").innerHTML = formatter2.format(fraisGestionPortageo);
...
document.getElementById("myFraisPortup").innerHTML = formatter2.format(fraisPortup);document.getElementById("myFraisGestionPortageo").innerHTML = formatter2.format(fraisGestionPortageo);
document.getElementById("myFraisGestionPortup").innerHTML = formatter2.format(fraisGestionPortup);
...
document.getElementById("myFraisGestionCegelem").innerHTML = formatter2.format(fraisGestionCegelem);
...
document.getElementById("myFraisGestionLabelVie").innerHTML = formatter2.format(fraisGestionLabelVie);
...
document.getElementById("myFraisGestionKingurley").innerHTML = formatter2.format(fraisGestionKingurley);
...
document.getElementById("myFraisGestionAdmission").innerHTML = formatter2.format(fraisGestionAdmission);
...
console.log(fraisGestionEPPortage);
...
document.getElementById("myFraisGestionRHSolutions").innerHTML = formatter2.format(fraisGestionRHSolutions);
...
document.getElementById("myFraisGestionITG").innerHTML = formatter2.format(fraisGestionITG);
...
document.getElementById("myFraisGestionFreecadre").innerHTML = formatter2.format(fraisGestionFreecadre);

// Société TalentFactory

var tjmTalentFactory = url.searchParams.get("tjm");
var fraisTalentFactory = 360;
...
var fraisGestionTalentFactory = 15;
...
document.getElementById("myFraisGestionTalentFactory").innerHTML = formatter2.format(fraisGestionTalentFactory);
...
document.getElementById("myFraisGestionUmalis").innerHTML = formatter2.format(fraisGestionUmalis);
...
document.getElementById("myFraisGestionHighteckers").innerHTML = formatter2.format(fraisGestionHighteckers);
