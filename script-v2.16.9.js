...
var fraisGestionBePortage = 8; //get
...
function updateBePortage() { 
    fraisGestionTest = document.getElementById("myFraisGestionBePortage").value;

    if (fraisGestionTest == 5){
